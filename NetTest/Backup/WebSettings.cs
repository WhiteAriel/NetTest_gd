...
namespace NetTest
{
    public partial class WebSettings : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        public void Init()
        {
            ...
            //iNumContinuous = Convert.ToInt16(inis.IniReadValue("Web", "NumContinuous"));
            ...
            //iTimeLast = int.Parse(inis.IniReadValue("Web", "TimeLast"));
            ...
            //iBool = Convert.ToInt16(inis.IniReadValue("Web", "CheckContinuous"));
            int.TryParse(inis.IniReadValue("Web", "CheckContinuous"), out iBool);
            if (iBool > 0)
            {
